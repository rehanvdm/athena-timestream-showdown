...
export class AthenaBase {
  ...
  public async query(
    ...
    let queryTime, queryAndResultRetrievalTime = 0;
    ...
    queryAndResultRetrievalTime = Date.now() - startTime;
    return {
      queryTime,
      queryAndResultRetrievalTime,
      data: results,
      ...
      for (let c = 0; c < columns.length; c++) {
        ...
        switch (column.Type) {
          ...
          case 'timestamp':
            ...
            resultRow[column.Name] = new Date(cell);
            break;
          default:
